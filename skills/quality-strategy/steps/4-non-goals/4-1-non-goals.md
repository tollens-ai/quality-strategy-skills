...
A non-goal is a decision about what the user *doesn't care about* — exactly the class of thing the goal-traceability rule says must be framed against stated goals and confirmed, never inherited from the pre-read and inferred. Two rules apply to every candidate before it can enter the doc:
